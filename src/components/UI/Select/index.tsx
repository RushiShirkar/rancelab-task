...
const SelectContext = React.createContext<{ error?: string; label?: string }>({})
...
function Select({
  ...
  return (
    <SelectContext.Provider value={{ error, label }}>
...
function SelectTrigger({
  ...
  const { error, label } = React.useContext(SelectContext)
